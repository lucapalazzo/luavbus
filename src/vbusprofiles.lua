...
'{ \
  ...
  "objects": [ \
    [ 0, 2, 0, "Temperature sensor 1", 0.1, "°C" ], \
    [ 2, 2, 0, "Temperature sensor 2", 0.1, "°C" ], \
    [ 4, 2, 0, "Temperature sensor 3", 0.1, "°C" ], \
    [ 6, 2, 0, "Temperature sensor 4", 0.1, "°C" ], \
    [ 8, 2, 0, "Temperature sensor 5", 0.1, "°C" ], \
    [ 10, 2, 0, "Temperature sensor 6", 0.1, "°C" ], \
    [ 12, 2, 0, "Temperature sensor 7", 0.1, "°C" ], \
    [ 14, 2, 0, "Temperature sensor 8", 0.1, "°C" ], \
    [ 16, 2, 0, "Temperature sensor 9", 0.1, "°C" ], \
    [ 18, 2, 0, "Temperature sensor 10", 0.1, "°C" ], \
    [ 20, 2, 0, "Temperature sensor 11", 0.1, "°C" ], \
    [ 22, 2, 0, "Temperature sensor 12", 0.1, "°C" ], \
    [ 24, 2, 0, "Temperature sensor 13", 0.1, "°C" ], \
    [ 26, 2, 0, "Temperature sensor 14", 0.1, "°C" ], \
    [ 28, 2, 0, "Temperature sensor 15", 0.1, "°C" ], \
    [ 30, 2, 0, "Irridiation sensor 16", 1, "W/m²" ], \
    [ 32, 2, 0, "Temperature sensor 17", 0.1, "°C" ], \
    [ 34, 2, 0, "Temperature sensor 18", 0.1, "°C" ], \
    [ 36, 2, 0, "Temperature sensor 19", 0.1, "°C" ], \
    [ 38, 2, 0, "Temperature sensor 20", 0.1, "°C" ], \
